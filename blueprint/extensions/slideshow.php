...
//                         $data['captions'][] = trim( ob_get_clean() );
        ...
        jQuery(window).load(function($) {
            jQuery('#slider').orbit({
                        ...
                        data: '<?php echo is_string($data) ? $data : ''; ?>',
    ...
    static function prepare_single_listing ($listing = false) {
        ...
        if ($listing && isset($listing['images'])) {
          ...
          if (empty($listing['images'])) {
            ...
            $slide_array['images'][] = PLS_Image::load($image['url'], array('resize' => array('w' => 940, 'h' => 415), 'fancybox' => false, 'as_html' => false, 'allow_dragonfly' => false));

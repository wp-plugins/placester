...
<?php $compliance_message = wp_parse_args($compliance_message, array('agent_name' => false, 'office_name' => false, 'img' => true, 'disclaimer' => false)); ?>
<div class="clear"></div>
<div class="compliance-wrapper">
  ...
  <?php if ($compliance_message['agent_name']): ?>
    <p class="property-details-compliance p4">Listing Agent: <?php echo $compliance_message['agent_name']; ?></p>	
  <?php endif ?>
  <?php if ($compliance_message['office_name']): ?>
    <p class="property-details-compliance p4">Courtesy of: <?php echo $compliance_message['office_name']; ?></p>	
  <?php endif ?>

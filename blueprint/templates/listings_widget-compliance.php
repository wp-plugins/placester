...
<div class="compliance-wrapper">
	...
	<?php if ($compliance_message['agent_name']): ?>
		<p class="widget-compliance">Listing Agent: <?php echo $compliance_message['agent_name'] ?></p>
    <?php endif ?>
    <?php if (!empty($compliance_message['agent_license'])): ?>
        <p class="widget-compliance">DRE#: <?php echo $compliance_message['agent_license'] ?></p>
    <?php endif ?>
    <?php if (!empty($compliance_message['office_name'])): ?>
        <p class="widget-compliance">Courtesy of: <?php echo $compliance_message['office_name'] ?></p>
    <?php endif ?>
    <?php if (!empty($compliance_message['office_phone'])): ?>
        <p class="widget-compliance">Agent Phone: <?php echo $compliance_message['office_phone'] ?></p>
    <?php endif ?>
    <?php if (!empty($compliance_message['co_agent_name'])): ?>
        <p class="widget-compliance">Co-Listing Agent: <?php echo $compliance_message['co_agent_name'] ?></p>
    <?php endif ?>
    <?php if (!empty($compliance_message['co_office_name'])): ?>
        <p class="widget-compliance">Co-Listing Office: <?php echo $compliance_message['co_office_name'] ?></p>
    <?php endif ?>
